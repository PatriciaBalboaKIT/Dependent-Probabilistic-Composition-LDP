...
def adapt_utility(eps_s, N, max_len, data_type):
    ...
    ORIGINAL_TRAJECTORIES_FILE = f"Results_{data_type}_Original_epsS{eps_s}_N{N}_{max_len}/original_data.csv"
    ANON_TRAJECTORIES_TEMPLATE = f"Results_{data_type}_Original_epsS{eps_s}_N{N}_{max_len}/Trajectories/anon{{}}.csv"
    OUTPUT_FILE = f"Utility_{data_type}_Original_N{N}_{max_len}_epsS{eps_s}.csv"
